{!! view_render_event('admin.initiatives.create.contact_person.form_controls.before') !!}

<v-contact-component :data="person"></v-contact-component>

{!! view_render_event('admin.initiatives.create.contact_person.form_controls.after') !!}
    ...
    >
        ...
        <x-admin::form.control-group>
            <x-admin::form.control-group.label class="required">
                @lang('admin::app.initiatives.common.contact.name')
            ...
            <x-admin::lookup
                ...
                :placeholder="trans('admin::app.initiatives.common.contact.name')"
        ...
        <x-admin::form.control-group>
            <x-admin::form.control-group.label class="required">
                @lang('admin::app.initiatives.common.contact.email')
            </x-admin::form.control-group.label>
        ...
        <x-admin::form.control-group>
            <x-admin::form.control-group.label>
                @lang('admin::app.initiatives.common.contact.contact-number')
            </x-admin::form.control-group.label>
        ...
        <x-admin::form.control-group>
            <x-admin::form.control-group.label>
                @lang('admin::app.initiatives.common.contact.organization')
            </x-admin::form.control-group.label>
