...
@pushOnce('scripts')
    <script type="text/x-template" id="v-initiative-mail-activity-template">
        <Teleport to="body">
            <x-admin::form
            ...
            >
                <form @submit="handleSubmit($event, save)">
                    <x-admin::modal ref="initiativeMailModal">
                        <x-slot:header>
    ...
    <script type="module">
        app.component('v-initiative-mail-activity', {
            template: '#v-initiative-mail-activity-template',
            ...
            methods: {
                openModal() {
                    this.$refs.initiativeMailModal.open();
                },
                ...
                save(params) {
                    ...
                    let data = Object.assign({}, params, {
                        initiative_id: this.entity.id
                    });

                    this.$axios.post("{{ route('admin.initiatives.mail-activity.store') }}", data)
                        .then(response => {
                            this.isLoading = false;
                            this.$refs.initiativeMailModal.close();
