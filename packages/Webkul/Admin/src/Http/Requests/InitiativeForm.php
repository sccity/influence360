...
class InitiativeForm extends FormRequest
{
    /**
     * @var array
     */
    ...
    {
        return [
            'products.*.product_id.exists'      => trans('admin::app.initiatives.selected-product-not-exist'),
            'products.*.name.required_with'     => trans('admin::app.initiatives.product-name-required'),
            'products.*.price.required_with'    => trans('admin::app.initiatives.product-price-required'),
            'products.*.quantity.required_with' => trans('admin::app.initiatives.product-quantity-required'),
        ];
    }
}
