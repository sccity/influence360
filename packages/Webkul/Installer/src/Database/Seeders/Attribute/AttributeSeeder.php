...
class AttributeSeeder extends Seeder
{
    ...
    public function run($parameters = [])
    {
        ...
        DB::table('attributes')->insert([
            ...
            [
                'code'            => 'title',
                'name'            => trans('installer::app.seeders.attributes.initiatives.title', [], $defaultLocale),
                'type'            => 'text',
                ...
                'code'            => 'description',
                'name'            => trans('installer::app.seeders.attributes.initiatives.description', [], $defaultLocale),
                'type'            => 'textarea',
                'entity_type'     => 'initiatives',
                'lookup_type'     => null,
                'validation'      => null,
                ...
                'name'            => trans('installer::app.seeders.attributes.initiatives.initiative-value', [], $defaultLocale),
                'type'            => 'price',
                'entity_type'     => 'initiatives',
                'lookup_type'     => null,
                'validation'      => null,
                ...
                'name'            => trans('installer::app.seeders.attributes.initiatives.source', [], $defaultLocale),
                'type'            => 'select',
                'entity_type'     => 'initiatives',
                ...
                'name'            => trans('installer::app.seeders.attributes.initiatives.type', [], $defaultLocale),
                'type'            => 'select',
                'entity_type'     => 'initiatives',
                ...
                'name'            => trans('installer::app.seeders.attributes.initiatives.expected-close-date', [], $defaultLocale),
                'type'            => 'date',
                'entity_type'     => 'initiatives',
                'lookup_type'     => null,
                'validation'      => null,
                ...
                'name'            => trans('installer::app.seeders.attributes.initiatives.pipeline', [], $defaultLocale),
                'type'            => 'lookup',
                'entity_type'     => 'initiatives',
                ...
                'name'            => trans('installer::app.seeders.attributes.initiatives.stage', [], $defaultLocale),
                'type'            => 'lookup',
                'entity_type'     => 'initiatives',
