...
Breadcrumbs::for('bill-files.create', function (BreadcrumbTrail $trail) {
...
Breadcrumbs::for('bill-files.edit', function (BreadcrumbTrail $trail, $billFile) {
    $trail->parent('bill-files');
...
Breadcrumbs::for('bills.view', function (BreadcrumbTrail $trail, $bill) {
    $trail->parent('bills');
    $trail->push($bill->bill_number, route('admin.bills.view', $bill->id));
});
